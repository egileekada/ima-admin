...
export function UserInfo({ id,img, user, useremail, bankdetail, date, verified, amount, status}:
    {img:string, id:string, user:string, useremail:string, bankdetail:string, amount:string, status:string, date:string, verified: boolean}){
    return(
        <ul className={styles.userData}>
            ...
            <li>
                <p style={{fontSize:'12px', color:"#02B449"}}>Approved</p>
            </li> 
