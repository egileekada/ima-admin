    ...
    return(
        <div> 
            <div className={styles.homeBottom}>
                ...
                <UserInfo id="001" user="John Emmanuel" verified={true} useremail="@john" img="/images/profilePics.png"  amount="N300,000" type="Funding wallet via Paystack" date="27/08/20222:30pm" 
                status='Completed'  />  
                <UserInfo id="001" user="John Emmanuel" verified={true} useremail="@john" img="/images/profilePics.png"  amount="N300,000" type="Funding wallet via Paystack" date="27/08/20222:30pm" 
                status='Pending'  />  
                <UserInfo id="001" user="John Emmanuel" verified={true} useremail="@john" img="/images/profilePics.png"  amount="N300,000" type="Funding wallet via Paystack" date="27/08/20222:30pm" 
