    ...
    return(
        <div> 
            <div className={styles.homeBottom}>
                ...
                type="Funded wallet" status="Pending"  /> 
                <UserInfo id="001" user="John Emmanuel" verified={true} useremail="@john" img="/images/profilePics.png"  amount="N300,000" date="27/08/20222:30pm" 
                type="Withdrawal to bank " status="Failed"  /> 
                <UserInfo id="001" user="John Emmanuel" verified={true} useremail="@john" img="/images/profilePics.png"  amount="N300,000" date="27/08/20222:30pm" 
                type="Funded wallet" status="Pending"  /> 
                <UserInfo id="001" user="John Emmanuel" verified={true} useremail="@john" img="/images/profilePics.png"  amount="N300,000" date="27/08/20222:30pm" 
                type="Withdrawal to bank " status="Pending"  /> 
                <UserInfo id="001" user="John Emmanuel" verified={true} useremail="@john" img="/images/profilePics.png"  amount="N300,000" date="27/08/20222:30pm" 
                type="Withdrawal to bank " status="Successful"  /> 
                <UserInfo id="001" user="John Emmanuel" verified={true} useremail="@john" img="/images/profilePics.png"  amount="N300,000" date="27/08/20222:30pm" 
                type="Funded wallet" status="Successful"  /> 
            </div>
