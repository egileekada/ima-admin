                ...
                <table className='text-xs bg-[#F7F8FA] '>
                    <thead style={{background: "#F7F8FA"}} >
                        <tr className='font-Poppins-Semibold bg-[#F7F8FA] ' >
                            ...
                            <td className='bg-white'>
                                <p className="w-28">Approved date</p>
                            </td> 
                            <td className='bg-white'>
                    ...
                    <tbody> 
                        <tr className='font-Poppins-Semibold text-xs ' >
                            ...
                            <td className='bg-white'>
                                <button className=" w-28 mt-6 mb-3 flex items-center " > 
                                    <p className=" text-[#0984D6] cursor-pointer ">Reciept</p>
                                    <img src="/images/download.png" className=" w-3 h-3 ml-2 " alt='avatar' />
                                </button>
                            </td> 
                            <td className='bg-white'>
                                <div className="w-28 flex justify-center mt-6 mb-3"> 
                                    ...
                                    <button className=" text-[#EB3223] py-2 rounded-full ml-3 w-full  "  >Disburst</button> 
                                </div>
                            </td> 
                        </tr>  
                        <tr className='font-Poppins-Semibold text-xs ' >
